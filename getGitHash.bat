...
@ECHO #include "paddleCurvesApp.h">> %outputPath%%outputFile%
@ECHO.>> %outputPath%%outputFile%
@ECHO const wxString PaddleCurvesApp::versionString = _T("%gitTag%");>> %outputPath%%outputFile%
@ECHO const wxString PaddleCurvesApp::gitHash = _T("%gitHash%");>> %outputPath%%outputFile%
